  ...
  return (
    <div className="project-container">
      ...
      <ul className="project-list-itens">
        <li>
          The project was made from scratch in one week, so I was responsible for end-to-end
      ...
      <div className="border-project"></div>
      <ul className="project-list-itens">
        <li>JavaScript (ES6), ReactJs, NodeJs, ExpressJS, Insomnia, Bootstrap 5, Netflify, Heroku, npm, Git;</li>
      ...
      <p>
        This application is a game developed in one week during my Ironhack Web Development Bootcamp.
        I have always enjoyed trivia games so it was a great and fun challenge to develop it.
      </p>
      <p>
        Developed using JavaScript, pure CSS and HTML.
      </p>
      <h2 className="project-about">About this project</h2>
      <div className="border-project"></div>
      <ul className="project-list-itens">
        <li>
          The project was made from scratch in one, so I was responsible for end-to-end
          development and deploy of the game.
        </li>
      </ul>
      <h2 className="project-challenge">Technical Challenges</h2>
      <div className="border-project"></div>
      <ul className="project-list-itens">
        <li>Identify each element in the DOM is and how to select it to use in functions;</li>
        <li>How to insert new features without breaking the code;</li>
        <li>How to keep a clean clean with so many variables and DOM elements;</li>
